...
export default function RoadTripAtlantiquePage() {
  ...
  return (
    <>
      <Head>
        <title>Road Trip Atlantique - {t('site_name')}</title>
        <meta name="description" content="Parcourez la côte atlantique marocaine lors d'un road trip inoubliable. Découvrez des paysages époustouflants et des villages authentiques." />
      </Head>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            ROAD TRIP ATLANTIQUE
          </h1>
          <p className="text-xl md:text-2xl mb-8 leading-relaxed">
            Explorez la côte atlantique marocaine au volant de votre liberté
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Embarquez pour un road trip exceptionnel le long de la côte atlantique marocaine. 
                De Casablanca à Agadir, découvrez des paysages côtiers spectaculaires, des villages de pêcheurs authentiques et des plages sauvages.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Cette aventure sur roues vous offre la liberté d'explorer à votre rythme, 
                de vous arrêter dans des lieux magiques et de vivre des expériences uniques au bord de l'Atlantique.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  <div className="text-3xl font-bold text-blue-600 mb-2">7-10</div>
                  <div className="text-gray-600">Jours de liberté</div>
                </div>
                <div className="text-center p-4 bg-cyan-50 rounded-lg">
                  <div className="text-3xl font-bold text-cyan-600 mb-2">500+</div>
                  <div className="text-gray-600">Km de côte</div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Un itinéraire soigneusement conçu pour découvrir les plus beaux sites de la côte
            </p>
          </div>
      ...
      <section id="gallery" className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Découvrez les paysages magnifiques de la côte atlantique
            </p>
          </div>
      ...
      <section id="reservation" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-6 font-serif">
              Réservez Votre Road Trip
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Contactez-nous pour organiser votre aventure le long de la côte atlantique
            </p>
          </div>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl text-white/90 mb-8">
            Vivez l'aventure ultime le long de la côte atlantique marocaine
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
