...
export default function VoyagesAffairesHeader() {
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link href="/" className="flex items-center group">
              ...
              <span className="ml-2 sm:ml-3 text-xs sm:text-sm text-gray-400 font-medium">Business</span>
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            ...
            >
              <button className="text-blue-400 hover:text-blue-300 font-medium transition-colors duration-300 px-2 py-1 rounded border-b-2 border-blue-400 flex items-center">
                {t('menu.services')}
                  ...
                  {servicesLinks.map(({ href, label }) => (
                    <Link
                      ...
                      className={`block px-4 py-3 font-medium transition-colors duration-200 ${
                        href === '/services/voyages-affaires' 
