        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center group">
              ...
              <span className="ml-3 text-sm text-gray-400 font-medium">Business</span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-300 flex items-center space-x-2 font-medium"
              target="_blank"
