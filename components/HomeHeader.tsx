        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link href="/" className="flex items-center group">
              ...
              <span className="ml-2 sm:ml-3 text-xs sm:text-sm text-gray-400 font-medium">Accueil</span>
            </Link>
          </div>

          {/* Navigation Desktop */}
          <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            <Link href="/" className="text-yellow-400 hover:text-yellow-300 font-medium transition-colors duration-300 px-2 py-1 rounded border-b-2 border-yellow-400">
              {t('menu.home')}
            </Link>
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-gray-800">
            <nav className="px-4 py-3 space-y-2">
              <Link
                href="/"
                className="block text-yellow-400 font-medium transition-colors duration-300 px-3 py-2 rounded"
