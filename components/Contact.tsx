      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto">
            Disponible 24h/7j pour répondre à vos besoins de voyage
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            ...
            {/* Address */}
            <div className="group bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/50 hover:border-blue-300/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-playfair font-semibold text-slate-900 mb-2">{t('contact.info.agency')}</h3>
                  <p className="text-slate-600 leading-relaxed mb-3">
                    123 Avenue Mohammed V, Étage 3<br />
            ...
            {/* Phone */}
            <div className="group bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/50 hover:border-green-300/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
            ...
            {/* Email */}
            <div className="group bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/50 hover:border-amber-300/50 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/10">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/50 hover:border-green-300/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-r from-green-500 to-green-600 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
